 ...
 * @author juanangel
 */
public class Bees extends AbstractGameObject {
    
    ConcurrentLinkedQueue<IGameObject> gObjs = new ConcurrentLinkedQueue<IGameObject>();
   
    Bees(Position position) {
        super(position);    
    }
    
    Bees(Position position, int value, int life ) {
        super(position, value, life);    
    }
    
    Bees(Position position, int value, int life, ConcurrentLinkedQueue<IGameObject> gObjs) {
        super(position, value, life);    
        this.gObjs = gObjs;
    }
    
    Bees(JSONObject jObj) {
